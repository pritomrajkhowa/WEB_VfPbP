...
class UpdateProgramVisitor(Visitor):
    ...
    def update(self, tree):
        ...
        #print('-------------------------')
        #print(variable)
        #print(Update(variable, expression))
        #print('$$$$$$$$$$$$$$$$$$$$$$$$$')
        self.program.updates[variable] = Update(variable, expression)
        #print('$$$$$$$$$$$$$$$$$$$$$$$$$1')
        #print(self.program.updates[variable])
        #print('$$$$$$$$$$$$$$$$$$$$$$$$$1')
        ...
        #print('$$$$$$$$$$$$$$$$$$$$$$$$$2')
        #print(self.program.updates[variable].update_term(variable, 1).free_symbols)
        #print(self.program.variables)
        #print(self.forbidden_variables)
        #print('$$$$$$$$$$$$$$$$$$$$$$$$$2')
